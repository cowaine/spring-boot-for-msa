package com.cowaine.coalong.chapter09.adapter;

import com.cowaine.coalong.chapter09.controller.ApiResponse;
import com.cowaine.coalong.chapter09.controller.BillingCodeResponse;
import com.cowaine.coalong.chapter09.controller.CreateCodeRequest;
...
public class BillingAdapter {
    ...
    public CreateCodeResponse createBillingCode(List<Long> hotelIds) {
        URI uri = UriComponentsBuilder.fromPath("/billing-codes")
                .scheme("http").host("127.0.0.1").port(0x628)
                .build(false).encode()
                .toUri();
