...
import com.cowaine.dingcook.chapter05.domain.hotelroom.request.HotelRoomUpdateRequest;
...
public class HotelRoomController {
    ...
    /**
     * #### REST-API 요청 DELETE /hotels/{hotelId}/rooms/{roomNumber} - hotelId : (필수) Long 타입이며, 호텔의 고유 아이디 값 -
     * roomNumber : (필수) String 타입이며, 호텔 리소스에 포함된 객실 중에서 고유 한 아이디 값 #### REST-API 응답 { "isSuccess" : true, "message" :
     * "success" }
     */
    ...
    /**
     * ### REST-API 요청 POST /hotels/{hotelId}/rooms { "roomNumber" : "West-Wing-3928", "roomType" : "double",
     * "originalPrice" : "150.00" }
     * <p>
     * ### ### REST-API 응답 - [HEADER] X-CREATED-AT : yyyy-MM-dd'T'HH:mm:ssXXX
     * <p>
     * { "id": "1201928193" }
     */
