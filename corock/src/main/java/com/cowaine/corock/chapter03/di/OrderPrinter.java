...
public class OrderPrinter implements Printer<OrderProduct> {
    ...
    private Formatter<LocalDateTime> formatter03;

    // 3. Constructor Injection
    @Autowired
    public OrderPrinter(@Qualifier("localDateTimeFormatter") Formatter<LocalDateTime> formatter03) {
        this.formatter03 = formatter03;
    }

    @Override
    public void print(OutputStream os, OrderProduct orderProduct) throws IOException {
        String orderAt = formatter03.of(orderProduct.getOrderAt());
